...
def process_full_node(kf_dir, model, device, width, height):
    """Processes a 12-view node simultaneously with no memory constraints."""
...
def run_pipeline(input_dir, output_dir, width, height):
    ...
    print(f"Loading Pi3X model to {device} (48GB VRAM expected)...")
    ...
    for kf_dir in kf_dirs:
        ...
        # Save as a single cohesive node
